  ...
  return (
    <article className="min-w-0 rounded-lg border border-slate-200 bg-white p-4 shadow-sm sm:p-5">
      ...
      <div className="relative mt-4 pl-4">
        <div
          className="absolute bottom-2 left-[11px] top-2 w-0.5 bg-slate-200"
          aria-hidden="true"
        />
          ...
          {day.segments.map((segment, index) => (
            <div key={`${segment.start_time}-${index}`} className="relative">
              <div
                ...
                aria-hidden="true"
              />
              <div className="grid min-w-0 gap-3 rounded-md border border-slate-200 bg-slate-50 px-3 py-3 sm:grid-cols-[104px_minmax(0,1fr)] sm:px-4">
